...
document = TaggedLineDocument('NewsData')
model = Doc2Vec(document, size=20 , window=3, min_count=1, workers=4,iter=15,dm=0,hs=1)
#model.build_vocab(document)
#model.train(document)
model.save('NewsData.model')
